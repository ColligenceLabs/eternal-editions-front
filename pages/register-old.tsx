...
export default function RegisterOld(effect: React.EffectCallback, deps?: React.DependencyList) {
...
RegisterOld.getLayout = function getLayout(page: ReactElement) {
