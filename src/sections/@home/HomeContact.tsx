...
const contacts = [
  ...
  },
  {
    title: 'Consultations',
    description:
      'All consultation related requests can be done through these channels. No request is too small. Please be patient and we will do our best to provide a prompt response.',
    link: 'mailto:eternaleditions@gmail.com',
  },
];
