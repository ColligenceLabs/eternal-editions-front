        ...
        <RootStyle>
            <AboutHeaderSection>
                <Container maxWidth={false} sx={{px: {xs: '12px', lg: '80px'}}}>
                    ...
                    >
                        Eternal Editions gives new values in the live event industry.In the WEB 3.0 world, live event
                        planners and participants communicate, BUIDL up, and share together. Our mission is to make all
                        those experiences fun and convenient
                    </Box>
                </Container>
            </AboutHeaderSection>
        </RootStyle>
