...
// ----------------------------------------------------------------------
export default function EEAvatar({ image, account, nickname, ...other }: EEAvatarProps) {
  ...
  return (
    <Avatar src={image} alt={nickname} color={'default'} {...other}>
